...
const rxConc = document.getElementById("rxConc").value
if ((rxConc == 0.01 && mixtureNum == 0822 && formulaNum == 1724) || 
   (rxConc == 0.02 && mixtureNum == 3215 && formulaNum == 3302) || 
   (rxConc == 0.02 && mixtureNum == 3138 && formulaNum == 3302) ||
   (rxConc == 0.015 && mixtureNum == 3347 && formulaNum == 3194) ||
   (rxConc == 0.025 && mixtureNum == 3040 && formulaNum == 3288) ||
   (rxConc == 0.03 && mixtureNum == 3651 && formulaNum == 3792) ||
   (rxConc == 0.05 && mixtureNum == 3039 && formulaNum == 3287)||
